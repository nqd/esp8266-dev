...
my_spiffs_erase(u32_t addr, u32_t size) {
  ...
  os_printf("erasing\n");
  int res = spi_flash_erase_sector(addr/SECTOR_SIZE);
  os_printf("erase res = %d\n", res);
